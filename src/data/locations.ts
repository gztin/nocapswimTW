...
export const locations: PoolLocation[] = ([
  {
    ...
    capPolicy: 'not-required', sourceType: 'community', officialUrl: 'https://www.mandarinoriental.com/zh-hk/taipei/songshan',
  },
  {
    ...
    capPolicy: 'not-required', sourceType: 'community', officialUrl: 'https://www.marriott.com/en-us/hotels/tpewh-w-taipei/overview/',
  ...
  },
  {
    ...
    capPolicy: 'not-required', sourceType: 'community', officialUrl: 'https://www.grand-hotel.org/',
  },
  {
    ...
    capPolicy: 'not-required', sourceType: 'community', officialUrl: 'https://www.hyatt.com/grand-hyatt/en-US/taigh-grand-hyatt-taipei',
  },
  {
    ...
    capPolicy: 'not-required', sourceType: 'community', officialUrl: 'https://www.regenttaiwan.com/',
  },
  {
    ...
    capPolicy: 'not-required', sourceType: 'community', officialUrl: 'https://www.shangri-la.com/taipei/fareasternplazashangrila/',
  },
  {
    ...
    capPolicy: 'not-required', sourceType: 'community', officialUrl: 'https://www.marriott.com/en-us/hotels/tpetm-taipei-marriott-hotel/overview/',
  },
  {
    ...
    capPolicy: 'not-required', sourceType: 'community', officialUrl: 'https://sheraton.mhh-group.com/',
  },
  {
    ...
    capPolicy: 'not-required', sourceType: 'community', officialUrl: 'https://www.hilton.com/zh-hant/hotels/tsaqqqq-humble-house-taipei/',
  ...
  },
  {
    ...
    capPolicy: 'not-required', sourceType: 'community', officialUrl: 'https://yangmingshan.hexa.tw/',
  },
  {
    ...
    capPolicy: 'not-required', sourceType: 'community', officialUrl: 'https://taipei.grand-hilai.com.tw/',
  ...
  },
  {
    ...
    capPolicy: 'not-required', sourceType: 'community', officialUrl: 'https://www.caesarpark.com.tw/location-detail/caesar-park-banqiao/',
  },
  {
    ...
    capPolicy: 'not-required', sourceType: 'community', officialUrl: 'https://www.hilton.com/en/hotels/tsatchi-hilton-taipei-sinban/',
  },
  {
    ...
    capPolicy: 'not-required', sourceType: 'community', officialUrl: 'https://www.marriott.com/en-us/hotels/tpelf-four-points-linkou/overview/',
  },
  {
    ...
    capPolicy: 'not-required', sourceType: 'community', officialUrl: 'https://www.fullon-hotels.com.tw/fl/',
  },
  {
    ...
    capPolicy: 'not-required', sourceType: 'community', officialUrl: 'https://www.marriott.com/en-us/hotels/tpetw-the-westin-tashee-resort-taoyuan/overview/',
  },
  {
    ...
    capPolicy: 'not-required', sourceType: 'community', officialUrl: 'https://hoshinoresorts.com/zh_tw/hotels/hoshinoyaguguan/',
  },
  {
    ...
    capPolicy: 'not-required', sourceType: 'community', officialUrl: 'https://www.thelin.com.tw/',
  },
  {
    ...
    capPolicy: 'not-required', sourceType: 'community', officialUrl: 'https://www.lemeridien-taichung.com.tw/',
  ...
  },
  {
    ...
    capPolicy: 'not-required', sourceType: 'community', officialUrl: 'https://the-bal-e-villas.mydirectstay.com/tw/index.html',
  },
  {
    ...
    capPolicy: 'not-required', sourceType: 'community', officialUrl: 'https://wyndhamsunmoonlake.com/',
    notes: '原文列入名單；留言再次提到不用戴泳帽。',
  },
  {
    ...
    capPolicy: 'not-required', sourceType: 'community', officialUrl: 'https://www.ihg.com/hotelindigo/hotels/tw/zh/chiayi-county/cyigo/hoteldetail',
    notes: '原文列入名單；留言再次提到不用戴泳帽。',
  },
  {
    ...
    capPolicy: 'not-required', sourceType: 'community', officialUrl: 'https://www.justsleephotels.com/hushan/tw',
  ...
  },
  {
    ...
    capPolicy: 'not-required', sourceType: 'community', officialUrl: 'https://www.silks-club.com/zh-tw',
  },
  {
    ...
    capPolicy: 'not-required', sourceType: 'community', officialUrl: 'https://www.h2ohotel.com.tw/zh-tw',
  },
  {
    ...
    capPolicy: 'not-required', sourceType: 'community', officialUrl: 'https://www.grand-hotel.org/TW/official/main.aspx?gh=kh',
  },
  {
    ...
    capPolicy: 'not-required', sourceType: 'community', officialUrl: 'https://www.taiurbanresort.com.tw/',
    notes: '原文列入名單；留言再次提到不用戴泳帽。',
  },
  {
    ...
    capPolicy: 'not-required', sourceType: 'community', officialUrl: 'https://kenting.caesarpark.com.tw/',
    notes: '原文寫作「墾丁凱薩飯店」。',
  },
  {
    ...
    capPolicy: 'not-required', sourceType: 'community', officialUrl: 'https://www.westin-yilan.com.tw/',
  },
  {
    ...
    capPolicy: 'not-required', sourceType: 'community', officialUrl: 'https://www.dwsresort.com.tw/',
  },
  {
    ...
    capPolicy: 'not-required', sourceType: 'community', officialUrl: 'https://www.archipelago.com.tw/',
    notes: '原文列入名單；留言再次提到不用戴泳帽。',
  },
  {
    ...
    capPolicy: 'not-required', sourceType: 'community', officialUrl: 'https://taroko.silksplace.com/tw/',
  },
  {
    ...
    capPolicy: 'not-required', sourceType: 'community', officialUrl: 'https://www.kaddahotel.com/zh-tw',
  },
  {
    ...
    capPolicy: 'not-required', sourceType: 'community', officialUrl: 'https://www.discoveryhotel.com.tw/',
  },
  {
    ...
    capPolicy: 'not-required', sourceType: 'community', officialUrl: 'https://www.fourpoints-penghu.com/',
  },
 ] satisfies PoolLocation[]).map((location) => ({
  ...location,
  sourceName: '熱血史丹利大叔應援團',
  sourceUrl: 'https://www.facebook.com/share/p/1F9RNSgNU1/',
}))
